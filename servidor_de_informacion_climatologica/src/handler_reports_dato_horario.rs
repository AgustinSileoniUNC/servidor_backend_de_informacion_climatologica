...
use crate::{handler_date::date_since_ago, handler_estaciones::obtener_nombre_estacion_dato_horario, schema::reportes_dato_horario::{estacion, fecha, dsl::reportes_dato_horario}, models::DatoHorario, connection_db::establish_connection};
...
fn consult_reports_dato_horario(alias:&str ,since_days:u64)-> Vec<DatoHorario>{
    ...
    let nombre_estacion = obtener_nombre_estacion_dato_horario(alias);
